(self["webpackChunkicode_run"] = self["webpackChunkicode_run"] || []).push([["packages_form_src_index_jsx-my-cli_node_modules_rc-util_es_Dom_dynamicCSS_js-my-cli_node_modu-cf2bcd"],{
...
;// CONCATENATED MODULE: ./packages/form/src/index.module.less
// extracted by mini-css-extract-plugin
/* harmony default export */ const index_module = ({"box":"packages-form-src-index-module__box","boxContent":"packages-form-src-index-module__boxContent","horizontal":"packages-form-src-index-module__horizontal","vertical":"packages-form-src-index-module__vertical"});
;// CONCATENATED MODULE: ./packages/form/src/index.jsx
...
var MyForm=/*#__PURE__*/function(_Component){_inherits(MyForm,_Component);var _super=_createSuper(MyForm);function MyForm(){var _this;_classCallCheck(this,MyForm);for(var _len=arguments.length,args=new Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}_this=_super.call.apply(_super,[this].concat(args));_this.formRef=/*#__PURE__*/index_js_default().createRef();_this.onReset=function(){_this.formRef.current.resetFields();};_this.onFill=function(){// this.formRef['current'].setFieldsValue({
//   aaa: 'Hello world!',
// });
_this.formRef.current.validateFields();};_this.prevSubmitDatas='';_this.pushValues=function(){var _this$props$submitDat=_this.props.submitData,submitData=_this$props$submitDat===void 0?{}:_this$props$submitDat;var prevSubmitDatas=JSON.stringify(submitData);if(prevSubmitDatas!==_this.prevSubmitDatas){if(!Object.keys(submitData).length){_this.onReset();}var newData={};Object.keys(submitData).forEach(function(keyName){if(typeof submitData[keyName]==='number'){newData[keyName]=submitData[keyName]+'';}else{newData[keyName]=submitData[keyName];}});_this.formRef.current.setFieldsValue(newData);_this.prevSubmitDatas=prevSubmitDatas;}};return _this;}_createClass(MyForm,[{key:"componentDidMount",value:function componentDidMount(){this.pushValues();}},{key:"componentDidUpdate",value:function componentDidUpdate(){this.pushValues();}},{key:"render",value:function render(){var _this$props=this.props,className=_this$props.className,style=_this$props.style,size=_this$props.size,layout=_this$props.layout,_this$props$labelWidt=_this$props.labelWidth,labelWidth=_this$props$labelWidt===void 0?8:_this$props$labelWidt,onSubmit=_this$props.onSubmit,_this$props$isLoading=_this$props.isLoading,isLoading=_this$props$isLoading===void 0?false:_this$props$isLoading,buttonAlign=_this$props.buttonAlign,children=_this$props.children;var formProps=_objectSpread({className:"".concat(index_module.box," ").concat(layout!=='inline'?index_module[layout]:''," ").concat(className||''),style:_extends({},style),size:size||'default'},layout==='inline'?{}:{labelCol:{xs:{span:24},sm:{span:labelWidth}},wrapperCol:{xs:{span:24},sm:{span:24-labelWidth}}});var buttonStyle={};if(layout!=='inline'){buttonStyle.width='100%';}if(buttonAlign!=='inputLeft'){buttonStyle.textAlign=buttonAlign;}return/*#__PURE__*/index_js_default().createElement(es_form/* default */.Z,_extends({ref:this.formRef,name:"time_related_controls"},formProps,{onFinish:function onFinish(fieldsValue){if(onSubmit&&typeof onSubmit==='function'){onSubmit();}}// onValuesChange={(changedValues, allValues) => {
//   console.log('Form onValuesChange', changedValues, allValues)
//   this.formRef.current.setFieldsValue(changedValues);
// }}
}),/*#__PURE__*/index_js_default().createElement(spin/* default */.Z,{spinning:isLoading,delay:100},/*#__PURE__*/index_js_default().createElement("div",{className:index_module.boxContent},children)));}}]);return MyForm;}(index_js_.Component);;
