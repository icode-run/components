(self["webpackChunkicode_run"] = self["webpackChunkicode_run"] || []).push([["packages_modal_src_index_jsx-my-cli_node_modules_ant-design_icons_es_icons_CheckCircleFilled_-da3d09"],{
...
var style = __webpack_require__(83553);
...
;// CONCATENATED MODULE: ./packages/modal/src/index.module.less
// extracted by mini-css-extract-plugin
/* harmony default export */ const index_module = ({"modalCover":"packages-modal-src-index-module__modalCover","modalCoverTransparent":"packages-modal-src-index-module__modalCoverTransparent","inEditor":"packages-modal-src-index-module__inEditor","inEditorTransparent":"packages-modal-src-index-module__inEditorTransparent","modalBox":"packages-modal-src-index-module__modalBox","modalHeader":"packages-modal-src-index-module__modalHeader","title":"packages-modal-src-index-module__title","close":"packages-modal-src-index-module__close","modalHeaderLine":"packages-modal-src-index-module__modalHeaderLine","modalBody":"packages-modal-src-index-module__modalBody","modalFooterOkBtn":"packages-modal-src-index-module__modalFooterOkBtn","modalFooterCancelBtn":"packages-modal-src-index-module__modalFooterCancelBtn"});
...
;// CONCATENATED MODULE: ./packages/modal/src/index.jsx
 ...
 * @author yanrong.tian
 * @date 2022/4/12 下午2:41:24
 *///
var Modal=/*#__PURE__*/function(_Component){_inherits(Modal,_Component);var _super=_createSuper(Modal);function Modal(){var _this;_classCallCheck(this,Modal);for(var _len=arguments.length,args=new Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}_this=_super.call.apply(_super,[this].concat(args));_this.onCancel=function(e){var _this$props=_this.props,_this$props$visible=_this$props.visible,visible=_this$props$visible===void 0?{}:_this$props$visible,onOk=_this$props.onOk;if(visible.onChange&&typeof visible.onChange==='function'){visible.onChange(false);}};_this.id=+new Date();_this.renderModal=function(){var _this$props2=_this.props,_this$props2$visible=_this$props2.visible,visible=_this$props2$visible===void 0?{}:_this$props2$visible,className=_this$props2.className,headerLine=_this$props2.headerLine,_this$props2$style=_this$props2.style,style=_this$props2$style===void 0?{}:_this$props2$style,isCover=_this$props2.isCover,title=_this$props2.title,children=_this$props2.children,_this$props2$boxWidth=_this$props2.boxWidth,boxWidth=_this$props2$boxWidth===void 0?500:_this$props2$boxWidth,isEditor=_this$props2.isEditor;var container;if(_this.node){container=_this.node;}else{container=document.getElementById(_this.id);if(!container){container=document.createElement('div');container.id=_this.id;document.body.appendChild(container);}}react_dom_index_js_default().render(/*#__PURE__*/index_js_default().createElement(config_provider/* default */.ZP,{prefixCls:"custom"},/*#__PURE__*/index_js_default().createElement("div",{className:isEditor?'':isCover?index_module.modalCover:index_module.modalCoverTransparent,style:isEditor?{width:'100%',height:'100%'}:{visibility:visible.value?'visible':'hidden',opacity:visible.value?1:0}},/*#__PURE__*/index_js_default().createElement("div",{className:"".concat(index_module.modalBox," ").concat(className||''),style:_extends({width:boxWidth+'px'},style)},/*#__PURE__*/index_js_default().createElement("div",{className:"".concat(index_module.modalHeader," ").concat(headerLine?index_module.modalHeaderLine:'')},/*#__PURE__*/index_js_default().createElement("div",{className:index_module.title},title),/*#__PURE__*/index_js_default().createElement("div",{className:index_module.close,onClick:function onClick(){_this.onCancel();}},"\xD7")),/*#__PURE__*/index_js_default().createElement("div",{className:index_module.modalBody},children)))),container);};return _this;}_createClass(Modal,[{key:"componentDidMount",value:function componentDidMount(){this.renderModal();}},{key:"componentWillUnmount",value:function componentWillUnmount(){if(document.getElementById(this.id)){document.body.removeChild(document.getElementById(this.id));}}},{key:"componentDidUpdate",value:function componentDidUpdate(){this.renderModal();}},{key:"render",value:function render(){var _this2=this;var _this$props3=this.props,isEditor=_this$props3.isEditor,isCover=_this$props3.isCover,_this$props3$visible=_this$props3.visible,visible=_this$props3$visible===void 0?{}:_this$props3$visible;return isEditor?/*#__PURE__*/index_js_default().createElement("div",{ref:function ref(node){_this2.node=node;},className:isCover?index_module.inEditor:index_module.inEditorTransparent,style:visible.value?{}:{opacity:0.7}}):/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null);}}]);return Modal;}(index_js_.Component);/* harmony default export */ const src = (Modal);
