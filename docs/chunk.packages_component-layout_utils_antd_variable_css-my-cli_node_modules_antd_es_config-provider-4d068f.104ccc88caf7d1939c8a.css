...
@font-face {
  font-family: 'OthelloOutline';
  src: url(https://icode-run.github.io/icodeRun/OthelloOutline-Regular.ttf) format('truetype');
  font-style: normal;
  font-weight: 400;
...
@font-face {
  ...
  src: url("https://icode-run.github.io/icodeRun/Square721 BT Roman.ttf") format('truetype');
  font-style: normal;
  font-weight: 400;
  font-display: fallback;
}
@font-face {
  font-family: 'Square721';
  src: url("https://icode-run.github.io/icodeRun/Square721 BT Bold.ttf") format('truetype');
  font-style: normal;
  font-weight: 700;
  font-display: fallback;
}
@font-face {
  font-family: 'Square721Cn';
  src: url("https://icode-run.github.io/icodeRun/Square721 Cn BT Roman.ttf") format('truetype');
  font-style: inherit;
  font-weight: 400;
  font-display: fallback;
}
@font-face {
  font-family: 'Square721Cn';
  src: url("https://icode-run.github.io/icodeRun/Square721 Cn BT Bold.ttf") format('truetype');
  font-style: normal;
  font-weight: 700;
  font-display: fallback;
}
.packages-theme-src-index-module__box {
  display: flex;
  flex-direction: column;
  flex: auto;
  min-height: 100vh;
  color: var(--icode-text-color);
}
.packages-theme-src-index-module__colorsBox {
  margin: 0;
  padding: 0;
  list-style: none;
}
.packages-theme-src-index-module__colorsBox li {
  margin: 2px;
  padding: 0;
  list-style: none;
  width: 15px;
...
.packages-theme-src-index-module__colorsBox li:first-child {
  width: 40px;
}
...
/* stylelint-disable declaration-bang-space-before,no-duplicate-selectors,string-no-newline */
html {
  --icode-primary-color: #1890ff;
  --icode-primary-color-hover: #40a9ff;
  --icode-primary-color-active: #096dd9;
  --icode-primary-color-outline: rgba(24, 144, 255, 0.2);
  --icode-primary-1: #e6f7ff;
  --icode-primary-2: #bae7ff;
  --icode-primary-3: #91d5ff;
  --icode-primary-4: #69c0ff;
  --icode-primary-5: #40a9ff;
  --icode-primary-6: #1890ff;
  --icode-primary-7: #096dd9;
  --icode-primary-color-deprecated-pure: ;
  --icode-primary-color-deprecated-l-35: #cbe6ff;
  --icode-primary-color-deprecated-l-20: #7ec1ff;
  --icode-primary-color-deprecated-t-20: #46a6ff;
  --icode-primary-color-deprecated-t-50: #8cc8ff;
  --icode-primary-color-deprecated-f-12: rgba(24, 144, 255, 0.12);
  --icode-primary-color-active-deprecated-f-30: rgba(230, 247, 255, 0.3);
  --icode-primary-color-active-deprecated-d-02: #dcf4ff;
  --icode-success-color: #52c41a;
  --icode-success-color-hover: #73d13d;
  --icode-success-color-active: #389e0d;
  --icode-success-color-outline: rgba(82, 196, 26, 0.2);
  --icode-success-color-deprecated-bg: #f6ffed;
  --icode-success-color-deprecated-border: #b7eb8f;
  --icode-error-color: #ff4d4f;
  --icode-error-color-hover: #ff7875;
  --icode-error-color-active: #d9363e;
  --icode-error-color-outline: rgba(255, 77, 79, 0.2);
  --icode-error-color-deprecated-bg: #fff2f0;
  --icode-error-color-deprecated-border: #ffccc7;
  --icode-warning-color: #faad14;
  --icode-warning-color-hover: #ffc53d;
  --icode-warning-color-active: #d48806;
  --icode-warning-color-outline: rgba(250, 173, 20, 0.2);
  --icode-warning-color-deprecated-bg: #fffbe6;
  --icode-warning-color-deprecated-border: #ffe58f;
  --icode-info-color: #1890ff;
  --icode-info-color-deprecated-bg: #e6f7ff;
  --icode-info-color-deprecated-border: #91d5ff;
  --icode-text-color: rgba(0, 0, 0, 0.85);
  --icode-disabled-color: rgba(0, 0, 0, 0.25);
  --icode-border-color-base: rgba(217, 217, 217, 1);
}
...
a:hover {
  color: var(--icode-primary-color-hover);
}
a:active {
  color: var(--icode-primary-color-active);
}
a:active,
a:hover {
  text-decoration: none;
...
a[disabled] {
  color: var(--icode-disabled-color);
  cursor: not-allowed;
}
pre,
code,
...
::-moz-selection {
  color: #fff;
  background: var(--icode-primary-color);
}
::selection {
  color: #fff;
  background: var(--icode-primary-color);
...
html {
  --antd-wave-shadow-color: var(--icode-primary-color);
  --scroll-bar: 0;
}
...
.custom-click-animating-node {
  ...
  box-shadow: 0 0 0 0 var(--icode-primary-color);
...
@-webkit-keyframes waveEffect {
  100% {
    box-shadow: 0 0 0 var(--icode-primary-color);
...
.custom-alert-success {
  background-color: var(--icode-success-color-deprecated-bg);
  border: 1px solid var(--icode-success-color-deprecated-border);
}
.custom-alert-success .custom-alert-icon {
  color: var(--icode-success-color);
}
.custom-alert-info {
  background-color: var(--icode-info-color-deprecated-bg);
  border: 1px solid var(--icode-info-color-deprecated-border);
}
.custom-alert-info .custom-alert-icon {
  color: var(--icode-info-color);
}
.custom-alert-warning {
  background-color: var(--icode-warning-color-deprecated-bg);
  border: 1px solid var(--icode-warning-color-deprecated-border);
}
.custom-alert-warning .custom-alert-icon {
  color: var(--icode-warning-color);
}
.custom-alert-error {
  background-color: var(--icode-error-color-deprecated-bg);
  border: 1px solid var(--icode-error-color-deprecated-border);
}
.custom-alert-error .custom-alert-icon {
  color: var(--icode-error-color);
}
...
.custom-anchor-ink-ball {
  ...
  height: 8px;
  background-color: #fff;
  border: 2px solid var(--icode-primary-color);
  border-radius: 8px;
...
.custom-badge-status-success {
  background-color: var(--icode-success-color);
}
.custom-badge-status-processing {
  position: relative;
  background-color: var(--icode-primary-color);
}
.custom-badge-status-processing::after {
  ...
  width: 100%;
  height: 100%;
  border: 1px solid var(--icode-primary-color);
  border-radius: 50%;
...
.custom-badge-status-error {
  background-color: var(--icode-error-color);
}
.custom-badge-status-warning {
  background-color: var(--icode-warning-color);
}
...
.custom-breadcrumb > span:last-child .custom-breadcrumb-separator {
  display: none;
}
...
.custom-btn:focus {
  color: var(--icode-primary-color-hover);
  border-color: var(--icode-primary-color-hover);
  background: #fff;
}
...
.custom-btn:active {
  color: var(--icode-primary-color-active);
  border-color: var(--icode-primary-color-active);
  background: #fff;
}
...
.custom-btn-primary {
  color: #fff;
  border-color: var(--icode-primary-color);
  background: var(--icode-primary-color);
...
.custom-btn-primary:focus {
  color: #fff;
  border-color: var(--icode-primary-color-hover);
  background: var(--icode-primary-color-hover);
}
...
.custom-btn-primary:active {
  color: #fff;
  border-color: var(--icode-primary-color-active);
  background: var(--icode-primary-color-active);
}
...
.custom-btn-group .custom-btn-primary:not(:first-child):not(:last-child) {
  border-right-color: var(--icode-primary-5);
  border-left-color: var(--icode-primary-5);
}
...
.custom-btn-danger {
  color: #fff;
  border-color: var(--icode-error-color);
  background: var(--icode-error-color);
  text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.12);
  box-shadow: 0 2px 0 rgba(0, 0, 0, 0.045);
}
...
.custom-btn-danger:focus {
  color: #fff;
  border-color: var(--icode-error-color-hover);
  background: var(--icode-error-color-hover);
}
...
.custom-btn-danger:active {
  color: #fff;
  border-color: var(--icode-error-color-active);
  background: var(--icode-error-color-active);
}
...
.custom-btn-dangerous:focus {
  color: var(--icode-error-color-hover);
  border-color: var(--icode-error-color-hover);
  background: #fff;
}
...
.custom-btn-dangerous:active {
  color: var(--icode-error-color-active);
  border-color: var(--icode-error-color-active);
  background: #fff;
}
...
.custom-btn > .custom-btn-loading-icon:only-child .anticon {
  padding-right: 0;
}
.custom-btn-group {
  position: relative;
...
.custom-btn-group-lg > .custom-btn,
.custom-btn-group-lg > span > .custom-btn {
  height: 40px;
  padding: 6.4px 15px;
  font-size: 16px;
  border-radius: 0;
}
.custom-btn-group-lg .custom-btn.custom-btn-icon-only {
  width: 40px;
  height: 40px;
  padding-right: 0;
  padding-left: 0;
}
.custom-btn-group-sm > .custom-btn,
.custom-btn-group-sm > span > .custom-btn {
  height: 24px;
  padding: 0px 7px;
  font-size: 14px;
  border-radius: 0;
}
.custom-btn-group-sm > .custom-btn > .anticon,
.custom-btn-group-sm > span > .custom-btn > .anticon {
  font-size: 14px;
}
.custom-btn-group-sm .custom-btn.custom-btn-icon-only {
  width: 24px;
  height: 24px;
  padding-right: 0;
  padding-left: 0;
...
.custom-btn.custom-btn-background-ghost {
  color: var(--icode-text-color);
  border-color: var(--icode-border-color-base);
}
.custom-btn.custom-btn-background-ghost,
...
.custom-picker-calendar-full .custom-picker-panel .custom-picker-cell-selected:hover .custom-picker-calendar-date-today {
  background: var(--icode-primary-1);
}
...
.custom-card-rtl .custom-card-grid {
  float: right;
}
...
.custom-card-rtl .custom-card-actions > li {
  float: right;
}
...
.custom-card-loading-content p {
  margin: 0;
}
.custom-card-loading-block {
  height: 14px;
  margin: 4px 0;
...
.custom-cascader-menu-item-active:not(.custom-cascader-menu-item-disabled):hover {
  font-weight: 600;
  background-color: var(--icode-primary-1);
}
...
.custom-collapse-icon-position-right > .custom-collapse-item > .custom-collapse-header {
  position: relative;
  padding: 12px 16px;
  padding-right: 40px;
}
.custom-collapse-icon-position-right > .custom-collapse-item > .custom-collapse-header .custom-collapse-arrow {
  position: absolute;
  top: 50%;
  right: 16px;
  left: auto;
...
.custom-picker-focused {
  border-color: var(--icode-primary-5);
...
.custom-picker-focused {
  border-color: var(--icode-primary-color-hover);
  box-shadow: 0 0 0 2px var(--icode-primary-color-outline);
  border-right-width: 1px !important;
  outline: 0;
}
.custom-input-rtl .custom-picker-focused {
...
.custom-picker-input > input::-moz-placeholder {
  opacity: 1;
}
.custom-picker-input > input:-ms-input-placeholder {
  color: #bfbfbf;
  -ms-user-select: none;
      user-select: none;
}
...
.custom-picker-input > input:-moz-placeholder-shown {
  text-overflow: ellipsis;
}
.custom-picker-input > input:-ms-input-placeholder {
  text-overflow: ellipsis;
...
.custom-picker-ranges .custom-picker-preset > .custom-tag-blue {
  color: var(--icode-primary-color);
  background: var(--icode-primary-1);
  border-color: var(--icode-primary-3);
  cursor: pointer;
}
...
.custom-picker-range-arrow::after {
  position: absolute;
  top: 1px;
  right: 1px;
  width: 10px;
...
.custom-picker-cell-in-view.custom-picker-cell-range-hover:not(.custom-picker-cell-in-range)::after {
  ...
  z-index: 0;
  height: 24px;
  border-top: 1px dashed var(--icode-primary-color-deprecated-l-20);
  border-bottom: 1px dashed var(--icode-primary-color-deprecated-l-20);
  transform: translateY(-50%);
  transition: all 0.3s;
  content: '';
}
...
.custom-picker-panel > :not(.custom-picker-date-panel) .custom-picker-cell-in-view.custom-picker-cell-in-range.custom-picker-cell-range-hover-end::before {
  background: var(--icode-primary-color-deprecated-l-35);
}
...
.custom-picker-cell-in-view.custom-picker-cell-range-hover-start::after {
  left: 6px;
  border-left: 1px dashed var(--icode-primary-color-deprecated-l-20);
  border-top-left-radius: 2px;
  border-bottom-left-radius: 2px;
}
...
.custom-picker-cell-in-view.custom-picker-cell-range-hover-end::after {
  right: 6px;
  border-right: 1px dashed var(--icode-primary-color-deprecated-l-20);
  border-top-right-radius: 2px;
  border-bottom-right-radius: 2px;
}
...
.custom-picker-time-panel-column-active {
  background: var(--icode-primary-color-active-deprecated-f-30);
}
...
.custom-divider-horizontal.custom-divider-with-text.custom-divider-dashed {
  border-top: 0;
}
...
.custom-divider-horizontal.custom-divider-with-text-left.custom-divider-no-default-orientation-margin-left .ant-divider-inner-text {
  padding-left: 0;
}
...
.custom-divider-horizontal.custom-divider-with-text-right.custom-divider-no-default-orientation-margin-right .ant-divider-inner-text {
  padding-right: 0;
}
.custom-divider-rtl {
  direction: rtl;
...
.custom-drawer-left.custom-drawer-open,
.custom-drawer-right.custom-drawer-open {
  width: 100%;
...
.custom-drawer-left.custom-drawer-open .custom-drawer-content-wrapper {
...
.custom-drawer-right.custom-drawer-open .custom-drawer-content-wrapper {
  box-shadow: -6px 0 16px -8px rgba(0, 0, 0, 0.08), -9px 0 28px 0 rgba(0, 0, 0, 0.05), -12px 0 48px 16px rgba(0, 0, 0, 0.03);
}
.custom-drawer-right.custom-drawer-open.no-mask {
  right: 1px;
...
.custom-drawer-top.custom-drawer-open,
.custom-drawer-bottom.custom-drawer-open {
  height: 100%;
  transition: transform 0.3s cubic-bezier(0.23, 1, 0.32, 1);
}
.custom-drawer-top {
...
.custom-drawer-top.custom-drawer-open .custom-drawer-content-wrapper {
...
.custom-drawer-bottom.custom-drawer-open .custom-drawer-content-wrapper {
  box-shadow: 0 -6px 16px -8px rgba(0, 0, 0, 0.08), 0 -9px 28px 0 rgba(0, 0, 0, 0.05), 0 -12px 48px 16px rgba(0, 0, 0, 0.03);
}
.custom-drawer-bottom.custom-drawer-open.no-mask {
  bottom: 1px;
  transform: translateY(1px);
}
.custom-drawer.custom-drawer-open .custom-drawer-mask {
  height: 100%;
  opacity: 1;
  transition: none;
...
.custom-drawer-header-close-only {
  padding-bottom: 0;
  border: none;
}
...
.custom-drawer .custom-picker-clear {
  background: #fff;
}
...
.custom-dropdown-show-arrow.custom-dropdown-placement-topCenter,
...
.custom-dropdown-show-arrow.custom-dropdown-placement-bottomCenter,
...
.custom-dropdown-placement-topCenter > .custom-dropdown-arrow,
...
.custom-dropdown-placement-bottomCenter > .custom-dropdown-arrow,
...
.custom-dropdown.custom-slide-down-enter.custom-slide-down-enter-active.custom-dropdown-placement-bottomCenter,
.custom-dropdown.custom-slide-down-appear.custom-slide-down-appear-active.custom-dropdown-placement-bottomCenter,
...
.custom-dropdown.custom-slide-up-enter.custom-slide-up-enter-active.custom-dropdown-placement-topCenter,
.custom-dropdown.custom-slide-up-appear.custom-slide-up-appear-active.custom-dropdown-placement-topCenter,
...
.custom-dropdown.custom-slide-down-leave.custom-slide-down-leave-active.custom-dropdown-placement-bottomCenter,
...
.custom-dropdown.custom-slide-up-leave.custom-slide-up-leave-active.custom-dropdown-placement-topCenter,
...
.custom-form-item .custom-upload {
  background: transparent;
}
.custom-form-item .custom-upload.custom-upload-drag {
  background: #fafafa;
}
.custom-form-item input[type='radio'],
.custom-form-item input[type='checkbox'] {
  width: 14px;
  height: 14px;
}
.custom-form-item .custom-radio-inline,
.custom-form-item .custom-checkbox-inline {
  display: inline-block;
  margin-left: 8px;
  font-weight: normal;
  vertical-align: middle;
...
.custom-form-item .custom-radio-inline:first-child,
.custom-form-item .custom-checkbox-inline:first-child {
  margin-left: 0;
}
.custom-form-item .custom-checkbox-vertical,
.custom-form-item .custom-radio-vertical {
  display: block;
}
.custom-form-item .custom-checkbox-vertical + .custom-checkbox-vertical,
.custom-form-item .custom-radio-vertical + .custom-radio-vertical {
  margin-left: 0;
}
.custom-form-item .custom-input-number + .custom-form-text {
  margin-left: 8px;
}
.custom-form-item .custom-input-number-handler-wrap {
  z-index: 2;
}
.custom-form-item .custom-select,
.custom-form-item .custom-cascader-picker {
  width: 100%;
}
.custom-form-item .custom-picker-calendar-year-select,
.custom-form-item .custom-picker-calendar-month-select,
.custom-form-item .custom-input-group .custom-select,
.custom-form-item .custom-input-group .custom-cascader-picker,
.custom-form-item .custom-input-number-group .custom-select,
.custom-form-item .custom-input-number-group .custom-cascader-picker {
  width: auto;
}
.custom-form-inline {
  display: flex;
...
.custom-form-horizontal .custom-form-item-control:not(.custom-col) {
  min-width: 0;
}
.custom-form-vertical .custom-form-item {
  flex-direction: column;
}
...
.custom-form-item-has-feedback .custom-input {
  padding-right: 24px;
}
.custom-form-item-has-feedback .custom-input-affix-wrapper .custom-input-suffix {
  padding-right: 18px;
}
.custom-form-item-has-feedback .custom-input-search:not(.custom-input-search-enter-button) .custom-input-suffix {
  right: 28px;
}
.custom-form-item-has-feedback .custom-switch {
  margin: 2px 0 4px;
}
.custom-form-item-has-feedback > .custom-select .custom-select-arrow,
.custom-form-item-has-feedback > .custom-select .custom-select-clear,
.custom-form-item-has-feedback :not(.custom-input-group-addon) > .custom-select .custom-select-arrow,
.custom-form-item-has-feedback :not(.custom-input-group-addon) > .custom-select .custom-select-clear,
.custom-form-item-has-feedback :not(.custom-input-number-group-addon) > .custom-select .custom-select-arrow,
.custom-form-item-has-feedback :not(.custom-input-number-group-addon) > .custom-select .custom-select-clear {
  right: 32px;
}
.custom-form-item-has-feedback > .custom-select .custom-select-selection-selected-value,
.custom-form-item-has-feedback :not(.custom-input-group-addon) > .custom-select .custom-select-selection-selected-value,
.custom-form-item-has-feedback :not(.custom-input-number-group-addon) > .custom-select .custom-select-selection-selected-value {
  padding-right: 42px;
}
.custom-form-item-has-feedback .custom-cascader-picker-arrow {
  margin-right: 19px;
}
.custom-form-item-has-feedback .custom-cascader-picker-clear {
  right: 32px;
}
.custom-form-item-has-feedback .custom-picker {
  padding-right: 29.2px;
}
.custom-form-item-has-feedback .custom-picker-large {
  padding-right: 29.2px;
}
.custom-form-item-has-feedback .custom-picker-small {
  padding-right: 25.2px;
}
.custom-form-item-has-feedback.custom-form-item-has-success .custom-form-item-children-icon,
.custom-form-item-has-feedback.custom-form-item-has-warning .custom-form-item-children-icon,
.custom-form-item-has-feedback.custom-form-item-has-error .custom-form-item-children-icon,
.custom-form-item-has-feedback.custom-form-item-is-validating .custom-form-item-children-icon {
  position: absolute;
  top: 50%;
  right: 0;
  z-index: 1;
...
.custom-form-item-has-success.custom-form-item-has-feedback .custom-form-item-children-icon {
  color: var(--icode-success-color);
...
.custom-form-item-has-warning :not(.custom-input-disabled):not(.custom-input-borderless).custom-input,
.custom-form-item-has-warning :not(.custom-input-affix-wrapper-disabled):not(.custom-input-affix-wrapper-borderless).custom-input-affix-wrapper,
.custom-form-item-has-warning :not(.custom-input-number-affix-wrapper-disabled):not(.custom-input-number-affix-wrapper-borderless).custom-input-number-affix-wrapper,
.custom-form-item-has-warning :not(.custom-input-disabled):not(.custom-input-borderless).custom-input:hover,
.custom-form-item-has-warning :not(.custom-input-affix-wrapper-disabled):not(.custom-input-affix-wrapper-borderless).custom-input-affix-wrapper:hover,
.custom-form-item-has-warning :not(.custom-input-number-affix-wrapper-disabled):not(.custom-input-number-affix-wrapper-borderless).custom-input-number-affix-wrapper:hover {
  background-color: #fff;
  border-color: var(--icode-warning-color);
}
.custom-form-item-has-warning :not(.custom-input-disabled):not(.custom-input-borderless).custom-input:focus,
.custom-form-item-has-warning :not(.custom-input-affix-wrapper-disabled):not(.custom-input-affix-wrapper-borderless).custom-input-affix-wrapper:focus,
.custom-form-item-has-warning :not(.custom-input-number-affix-wrapper-disabled):not(.custom-input-number-affix-wrapper-borderless).custom-input-number-affix-wrapper:focus,
.custom-form-item-has-warning :not(.custom-input-disabled):not(.custom-input-borderless).custom-input-focused,
.custom-form-item-has-warning :not(.custom-input-affix-wrapper-disabled):not(.custom-input-affix-wrapper-borderless).custom-input-affix-wrapper-focused,
.custom-form-item-has-warning :not(.custom-input-number-affix-wrapper-disabled):not(.custom-input-number-affix-wrapper-borderless).custom-input-number-affix-wrapper-focused {
  border-color: var(--icode-warning-color-hover);
  box-shadow: 0 0 0 2px var(--icode-warning-color-outline);
  border-right-width: 1px !important;
  outline: 0;
}
.custom-form-item-has-warning .custom-calendar-picker-open .custom-calendar-picker-input {
  border-color: var(--icode-warning-color-hover);
  box-shadow: 0 0 0 2px var(--icode-warning-color-outline);
  border-right-width: 1px !important;
  outline: 0;
}
.custom-form-item-has-warning .custom-input-prefix,
.custom-form-item-has-warning .custom-input-number-prefix {
  color: var(--icode-warning-color);
}
.custom-form-item-has-warning .custom-input-group-addon,
.custom-form-item-has-warning .custom-input-number-group-addon {
  color: var(--icode-warning-color);
  border-color: var(--icode-warning-color);
}
.custom-form-item-has-warning .has-feedback {
  color: var(--icode-warning-color);
}
.custom-form-item-has-warning.custom-form-item-has-feedback .custom-form-item-children-icon {
  color: var(--icode-warning-color);
  -webkit-animation-name: diffZoomIn3 !important;
          animation-name: diffZoomIn3 !important;
}
.custom-form-item-has-warning .custom-select:not(.custom-select-disabled):not(.custom-select-customize-input) .custom-select-selector {
  background-color: #fff;
  border-color: var(--icode-warning-color) !important;
}
.custom-form-item-has-warning .custom-select:not(.custom-select-disabled):not(.custom-select-customize-input).custom-select-open .custom-select-selector,
.custom-form-item-has-warning .custom-select:not(.custom-select-disabled):not(.custom-select-customize-input).custom-select-focused .custom-select-selector {
  border-color: var(--icode-warning-color-hover);
  box-shadow: 0 0 0 2px var(--icode-warning-color-outline);
  border-right-width: 1px !important;
  outline: 0;
}
.custom-form-item-has-warning .custom-input-number,
.custom-form-item-has-warning .custom-picker {
  background-color: #fff;
  border-color: var(--icode-warning-color);
}
.custom-form-item-has-warning .custom-input-number-focused,
.custom-form-item-has-warning .custom-picker-focused,
.custom-form-item-has-warning .custom-input-number:focus,
.custom-form-item-has-warning .custom-picker:focus {
  border-color: var(--icode-warning-color-hover);
  box-shadow: 0 0 0 2px var(--icode-warning-color-outline);
  border-right-width: 1px !important;
  outline: 0;
}
.custom-form-item-has-warning .custom-input-number:not([disabled]):hover,
.custom-form-item-has-warning .custom-picker:not([disabled]):hover {
  background-color: #fff;
  border-color: var(--icode-warning-color);
}
.custom-form-item-has-warning .custom-cascader-picker:focus .custom-cascader-input {
  border-color: var(--icode-warning-color-hover);
  box-shadow: 0 0 0 2px var(--icode-warning-color-outline);
  border-right-width: 1px !important;
  outline: 0;
...
.custom-form-item-has-error :not(.custom-input-disabled):not(.custom-input-borderless).custom-input,
.custom-form-item-has-error :not(.custom-input-affix-wrapper-disabled):not(.custom-input-affix-wrapper-borderless).custom-input-affix-wrapper,
.custom-form-item-has-error :not(.custom-input-number-affix-wrapper-disabled):not(.custom-input-number-affix-wrapper-borderless).custom-input-number-affix-wrapper,
.custom-form-item-has-error :not(.custom-input-disabled):not(.custom-input-borderless).custom-input:hover,
.custom-form-item-has-error :not(.custom-input-affix-wrapper-disabled):not(.custom-input-affix-wrapper-borderless).custom-input-affix-wrapper:hover,
.custom-form-item-has-error :not(.custom-input-number-affix-wrapper-disabled):not(.custom-input-number-affix-wrapper-borderless).custom-input-number-affix-wrapper:hover {
  background-color: #fff;
  border-color: var(--icode-error-color);
}
.custom-form-item-has-error :not(.custom-input-disabled):not(.custom-input-borderless).custom-input:focus,
.custom-form-item-has-error :not(.custom-input-affix-wrapper-disabled):not(.custom-input-affix-wrapper-borderless).custom-input-affix-wrapper:focus,
.custom-form-item-has-error :not(.custom-input-number-affix-wrapper-disabled):not(.custom-input-number-affix-wrapper-borderless).custom-input-number-affix-wrapper:focus,
.custom-form-item-has-error :not(.custom-input-disabled):not(.custom-input-borderless).custom-input-focused,
.custom-form-item-has-error :not(.custom-input-affix-wrapper-disabled):not(.custom-input-affix-wrapper-borderless).custom-input-affix-wrapper-focused,
.custom-form-item-has-error :not(.custom-input-number-affix-wrapper-disabled):not(.custom-input-number-affix-wrapper-borderless).custom-input-number-affix-wrapper-focused {
  border-color: var(--icode-error-color-hover);
  box-shadow: 0 0 0 2px var(--icode-error-color-outline);
  border-right-width: 1px !important;
  outline: 0;
}
.custom-form-item-has-error .custom-calendar-picker-open .custom-calendar-picker-input {
  border-color: var(--icode-error-color-hover);
  box-shadow: 0 0 0 2px var(--icode-error-color-outline);
  border-right-width: 1px !important;
  outline: 0;
}
.custom-form-item-has-error .custom-input-prefix,
.custom-form-item-has-error .custom-input-number-prefix {
  color: var(--icode-error-color);
}
.custom-form-item-has-error .custom-input-group-addon,
.custom-form-item-has-error .custom-input-number-group-addon {
  color: var(--icode-error-color);
  border-color: var(--icode-error-color);
}
.custom-form-item-has-error .has-feedback {
  color: var(--icode-error-color);
}
.custom-form-item-has-error.custom-form-item-has-feedback .custom-form-item-children-icon {
  color: var(--icode-error-color);
  -webkit-animation-name: diffZoomIn2 !important;
          animation-name: diffZoomIn2 !important;
}
.custom-form-item-has-error .custom-select:not(.custom-select-disabled):not(.custom-select-customize-input) .custom-select-selector {
  background-color: #fff;
  border-color: var(--icode-error-color) !important;
}
.custom-form-item-has-error .custom-select:not(.custom-select-disabled):not(.custom-select-customize-input).custom-select-open .custom-select-selector,
.custom-form-item-has-error .custom-select:not(.custom-select-disabled):not(.custom-select-customize-input).custom-select-focused .custom-select-selector {
  border-color: var(--icode-error-color-hover);
  box-shadow: 0 0 0 2px var(--icode-error-color-outline);
  border-right-width: 1px !important;
  outline: 0;
}
.custom-form-item-has-error .custom-input-group-addon .custom-select.custom-select-single:not(.custom-select-customize-input) .custom-select-selector,
.custom-form-item-has-error .custom-input-number-group-addon .custom-select.custom-select-single:not(.custom-select-customize-input) .custom-select-selector {
  background-color: inherit;
  border: 0;
  box-shadow: none;
}
.custom-form-item-has-error .custom-select.custom-select-auto-complete .custom-input:focus {
  border-color: var(--icode-error-color);
}
.custom-form-item-has-error .custom-input-number,
.custom-form-item-has-error .custom-picker {
  background-color: #fff;
  border-color: var(--icode-error-color);
}
.custom-form-item-has-error .custom-input-number-focused,
.custom-form-item-has-error .custom-picker-focused,
.custom-form-item-has-error .custom-input-number:focus,
.custom-form-item-has-error .custom-picker:focus {
  border-color: var(--icode-error-color-hover);
  box-shadow: 0 0 0 2px var(--icode-error-color-outline);
  border-right-width: 1px !important;
  outline: 0;
}
.custom-form-item-has-error .custom-input-number:not([disabled]):hover,
.custom-form-item-has-error .custom-picker:not([disabled]):hover {
  background-color: #fff;
  border-color: var(--icode-error-color);
}
.custom-form-item-has-error .custom-mention-wrapper .custom-mention-editor,
.custom-form-item-has-error .custom-mention-wrapper .custom-mention-editor:not([disabled]):hover {
  background-color: #fff;
  border-color: var(--icode-error-color);
}
.custom-form-item-has-error .custom-mention-wrapper.custom-mention-active:not([disabled]) .custom-mention-editor,
.custom-form-item-has-error .custom-mention-wrapper .custom-mention-editor:not([disabled]):focus {
  border-color: var(--icode-error-color-hover);
  box-shadow: 0 0 0 2px var(--icode-error-color-outline);
  border-right-width: 1px !important;
  outline: 0;
}
.custom-form-item-has-error .custom-cascader-picker:hover .custom-cascader-picker-label:hover + .custom-cascader-input.custom-input {
  border-color: var(--icode-error-color);
}
.custom-form-item-has-error .custom-cascader-picker:focus .custom-cascader-input {
  background-color: #fff;
  border-color: var(--icode-error-color-hover);
  box-shadow: 0 0 0 2px var(--icode-error-color-outline);
  border-right-width: 1px !important;
...
.custom-form-item-has-error .custom-transfer-list {
  border-color: var(--icode-error-color);
}
.custom-form-item-has-error .custom-transfer-list-search:not([disabled]) {
  border-color: #d9d9d9;
}
.custom-form-item-has-error .custom-transfer-list-search:not([disabled]):hover {
  border-color: var(--icode-primary-5);
  border-right-width: 1px !important;
}
.custom-input-rtl .custom-form-item-has-error .custom-transfer-list-search:not([disabled]):hover {
  border-right-width: 0;
  border-left-width: 1px !important;
}
.custom-form-item-has-error .custom-transfer-list-search:not([disabled]):focus {
  border-color: var(--icode-primary-color-hover);
  box-shadow: 0 0 0 2px var(--icode-primary-color-outline);
  border-right-width: 1px !important;
  outline: 0;
}
.custom-input-rtl .custom-form-item-has-error .custom-transfer-list-search:not([disabled]):focus {
  border-right-width: 0;
  border-left-width: 1px !important;
}
.custom-form-item-has-error .custom-radio-button-wrapper {
  border-color: var(--icode-error-color) !important;
}
.custom-form-item-has-error .custom-radio-button-wrapper:not(:first-child)::before {
  background-color: var(--icode-error-color);
}
.custom-form-item-has-error .custom-mentions {
  border-color: var(--icode-error-color) !important;
}
.custom-form-item-has-error .custom-mentions-focused,
.custom-form-item-has-error .custom-mentions:focus {
  border-color: var(--icode-error-color-hover);
  box-shadow: 0 0 0 2px var(--icode-error-color-outline);
  border-right-width: 1px !important;
  outline: 0;
}
.custom-form-item-is-validating.custom-form-item-has-feedback .custom-form-item-children-icon {
  display: inline-block;
  color: var(--icode-primary-color);
}
.custom-form {
...
.custom-form-item .custom-input-textarea-show-count::after {
  margin-bottom: -22px;
}
...
.custom-image-preview.customzoom-appear {
  transform: none;
  opacity: 0;
...
.custom-input-affix-wrapper::-moz-placeholder {
  opacity: 1;
}
.custom-input-affix-wrapper:-ms-input-placeholder {
  color: #bfbfbf;
  -ms-user-select: none;
      user-select: none;
}
...
.custom-input-affix-wrapper:-moz-placeholder-shown {
  text-overflow: ellipsis;
}
.custom-input-affix-wrapper:-ms-input-placeholder {
  text-overflow: ellipsis;
...
.custom-input:-moz-placeholder-shown {
  text-overflow: ellipsis;
}
.custom-input:-ms-input-placeholder {
  text-overflow: ellipsis;
...
.custom-input-password-icon {
  color: rgba(0, 0, 0, 0.45);
  cursor: pointer;
  transition: all 0.3s;
}
.custom-input-password-icon:hover {
  color: rgba(0, 0, 0, 0.85);
}
...
.custom-input-number-affix-wrapper::-moz-placeholder {
  opacity: 1;
}
.custom-input-number-affix-wrapper:-ms-input-placeholder {
  color: #bfbfbf;
  -ms-user-select: none;
      user-select: none;
}
...
.custom-input-number-affix-wrapper:-moz-placeholder-shown {
  text-overflow: ellipsis;
}
.custom-input-number-affix-wrapper:-ms-input-placeholder {
  text-overflow: ellipsis;
...
.custom-input-number::-moz-placeholder {
  opacity: 1;
}
.custom-input-number:-ms-input-placeholder {
  color: #bfbfbf;
  -ms-user-select: none;
      user-select: none;
}
...
.custom-input-number:-moz-placeholder-shown {
  text-overflow: ellipsis;
}
.custom-input-number:-ms-input-placeholder {
  text-overflow: ellipsis;
...
.custom-input-number-input::-moz-placeholder {
  opacity: 1;
}
.custom-input-number-input:-ms-input-placeholder {
  color: #bfbfbf;
  -ms-user-select: none;
      user-select: none;
}
...
.custom-input-number-input:-moz-placeholder-shown {
  text-overflow: ellipsis;
}
.custom-input-number-input:-ms-input-placeholder {
  text-overflow: ellipsis;
...
.custom-mentions::-moz-placeholder {
  opacity: 1;
}
.custom-mentions:-ms-input-placeholder {
  color: #bfbfbf;
  -ms-user-select: none;
      user-select: none;
}
...
.custom-mentions:-moz-placeholder-shown {
  text-overflow: ellipsis;
}
.custom-mentions:-ms-input-placeholder {
  text-overflow: ellipsis;
...
.custom-mentions > textarea::-moz-placeholder {
  opacity: 1;
}
.custom-mentions > textarea:-ms-input-placeholder {
  color: #bfbfbf;
  -ms-user-select: none;
      user-select: none;
}
...
.custom-mentions > textarea:-moz-placeholder-shown {
  text-overflow: ellipsis;
}
.custom-mentions > textarea:-ms-input-placeholder {
  text-overflow: ellipsis;
...
.custom-menu-inline .custom-menu-item-danger.custom-menu-item::after {
  border-right-color: var(--icode-error-color);
}
...
.custom-menu.custom-menu-root:focus-visible {
  box-shadow: 0 0 0 2px var(--icode-primary-1);
}
.custom-menu ul,
.custom-menu ol {
  margin: 0;
...
.custom-menu-horizontal:not(.custom-menu-dark) > .custom-menu-submenu-selected::after {
  border-bottom: 2px solid var(--icode-primary-color);
}
.custom-menu-horizontal > .custom-menu-item,
.custom-menu-horizontal > .custom-menu-submenu {
  position: relative;
...
.custom-menu-inline .custom-menu-item::after {
  ...
  right: 0;
  bottom: 0;
  border-right: 3px solid var(--icode-primary-color);
...
.custom-modal.customzoom-appear {
  transform: none;
  opacity: 0;
  -webkit-animation-duration: 0.3s;
          animation-duration: 0.3s;
...
.custom-page-header-back-button:focus,
...
.custom-page-header-heading-extra > *:first-child {
  margin-left: 0;
}
...
.custom-pagination-options-quick-jumper input::-moz-placeholder {
  opacity: 1;
}
.custom-pagination-options-quick-jumper input:-ms-input-placeholder {
  color: #bfbfbf;
  -ms-user-select: none;
      user-select: none;
}
...
.custom-pagination-options-quick-jumper input:-moz-placeholder-shown {
  text-overflow: ellipsis;
}
.custom-pagination-options-quick-jumper input:-ms-input-placeholder {
  text-overflow: ellipsis;
...
.custom-pagination.mini .custom-pagination-total-text,
.custom-pagination.mini .custom-pagination-simple-pager {
  height: 24px;
  line-height: 24px;
}
.custom-pagination.mini .custom-pagination-item {
  min-width: 24px;
  height: 24px;
  margin: 0;
  line-height: 22px;
}
.custom-pagination.mini .custom-pagination-item:not(.custom-pagination-item-active) {
  background: transparent;
  border-color: transparent;
}
.custom-pagination.mini .custom-pagination-prev,
.custom-pagination.mini .custom-pagination-next {
  min-width: 24px;
  height: 24px;
  margin: 0;
  line-height: 24px;
}
.custom-pagination.mini .custom-pagination-prev .custom-pagination-item-link,
.custom-pagination.mini .custom-pagination-next .custom-pagination-item-link {
  background: transparent;
  border-color: transparent;
}
.custom-pagination.mini .custom-pagination-prev .custom-pagination-item-link::after,
.custom-pagination.mini .custom-pagination-next .custom-pagination-item-link::after {
  height: 24px;
  line-height: 24px;
}
.custom-pagination.mini .custom-pagination-jump-prev,
.custom-pagination.mini .custom-pagination-jump-next {
  height: 24px;
  margin-right: 0;
  line-height: 24px;
}
.custom-pagination.mini .custom-pagination-options {
  margin-left: 2px;
}
.custom-pagination.mini .custom-pagination-options-size-changer {
  top: 0px;
}
.custom-pagination.mini .custom-pagination-options-quick-jumper {
  height: 24px;
  line-height: 24px;
}
.custom-pagination.mini .custom-pagination-options-quick-jumper input {
  padding: 0px 7px;
  width: 44px;
  height: 24px;
}
...
.custom-progress-inner:not(.custom-progress-circle-gradient) .custom-progress-circle-path {
  stroke: var(--icode-primary-color);
}
...
.custom-progress-status-success .custom-progress-inner:not(.custom-progress-circle-gradient) .custom-progress-circle-path {
  stroke: var(--icode-success-color);
}
...
.custom-radio-input:focus + .custom-radio-inner {
  box-shadow: 0 0 0 3px var(--icode-primary-1);
}
...
.custom-rate-disabled .custom-rate-star:hover {
  transform: scale(1);
}
.custom-rate-star {
  position: relative;
...
.custom-skeleton.custom-skeleton-active .custom-skeleton-content .custom-skeleton-title,
.custom-skeleton.custom-skeleton-active .custom-skeleton-content .custom-skeleton-paragraph > li {
...
.custom-skeleton.custom-skeleton-active .custom-skeleton-avatar {
  background: linear-gradient(90deg, rgba(190, 190, 190, 0.2) 25%, rgba(129, 129, 129, 0.24) 37%, rgba(190, 190, 190, 0.2) 63%);
  background-size: 400% 100%;
  -webkit-animation: custom-skeleton-loading 1.4s ease infinite;
          animation: custom-skeleton-loading 1.4s ease infinite;
}
.custom-skeleton.custom-skeleton-active .custom-skeleton-button {
  background: linear-gradient(90deg, rgba(190, 190, 190, 0.2) 25%, rgba(129, 129, 129, 0.24) 37%, rgba(190, 190, 190, 0.2) 63%);
  background-size: 400% 100%;
  -webkit-animation: custom-skeleton-loading 1.4s ease infinite;
          animation: custom-skeleton-loading 1.4s ease infinite;
}
.custom-skeleton.custom-skeleton-active .custom-skeleton-input {
  background: linear-gradient(90deg, rgba(190, 190, 190, 0.2) 25%, rgba(129, 129, 129, 0.24) 37%, rgba(190, 190, 190, 0.2) 63%);
  background-size: 400% 100%;
  -webkit-animation: custom-skeleton-loading 1.4s ease infinite;
          animation: custom-skeleton-loading 1.4s ease infinite;
}
.custom-skeleton.custom-skeleton-active .custom-skeleton-image {
  background: linear-gradient(90deg, rgba(190, 190, 190, 0.2) 25%, rgba(129, 129, 129, 0.24) 37%, rgba(190, 190, 190, 0.2) 63%);
  background-size: 400% 100%;
  -webkit-animation: custom-skeleton-loading 1.4s ease infinite;
          animation: custom-skeleton-loading 1.4s ease infinite;
...
.custom-slider-track {
  position: absolute;
  height: 4px;
  background-color: var(--icode-primary-3);
  border-radius: 2px;
  transition: background-color 0.3s;
}
.custom-slider-handle {
  ...
  margin-top: -5px;
  background-color: #fff;
  border: solid 2px var(--icode-primary-3);
  border-radius: 50%;
  box-shadow: 0;
  cursor: pointer;
  transition: border-color 0.3s, box-shadow 0.6s, transform 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.28);
}
.custom-slider-handle-dragging.custom-slider-handle-dragging.custom-slider-handle-dragging {
  border-color: var(--icode-primary-color-deprecated-t-20);
  box-shadow: 0 0 0 5px var(--icode-primary-color-deprecated-f-12);
}
...
.custom-slider:hover .custom-slider-track {
  background-color: var(--icode-primary-4);
}
.custom-slider:hover .custom-slider-handle:not(.custom-tooltip-open) {
  border-color: var(--icode-primary-4);
}
.custom-slider-mark {
  position: absolute;
  top: 14px;
...
.custom-slider-dot:first-child {
  margin-left: -4px;
}
.custom-slider-dot:last-child {
  margin-left: -4px;
}
.custom-slider-dot-active {
  border-color: var(--icode-primary-color-deprecated-t-50);
}
...
.custom-slider-rtl .custom-slider-dot {
  margin-right: -4px;
  margin-left: 0;
}
.custom-slider-rtl .custom-slider-dot:first-child {
  margin-right: -4px;
  margin-left: 0;
}
.custom-slider-rtl .custom-slider-dot:last-child {
  margin-right: -4px;
  margin-left: 0;
}
.custom-space {
...
.custom-table-small .custom-table-thead > tr > th {
  background-color: #fafafa;
}
.custom-table-small .custom-table-selection-column {
  width: 46px;
  min-width: 46px;
}
...
.custom-table-tbody > tr.custom-table-row-selected:hover > td {
  background: var(--icode-primary-color-active-deprecated-d-02);
}
...
.custom-table-filter-dropdown-tree .custom-tree-treenode-checkbox-checked .custom-tree-node-content-wrapper:hover {
  background-color: var(--icode-primary-2);
}
...
.custom-tag-checkable-checked {
  background-color: var(--icode-primary-6);
}
.custom-tag-checkable:active {
  background-color: var(--icode-primary-7);
}
...
.custom-tag-success {
  color: var(--icode-success-color);
  background: var(--icode-success-color-deprecated-bg);
  border-color: var(--icode-success-color-deprecated-border);
}
.custom-tag-processing {
  color: var(--icode-info-color);
  background: var(--icode-info-color-deprecated-bg);
  border-color: var(--icode-info-color-deprecated-border);
}
.custom-tag-error {
  color: var(--icode-error-color);
  background: var(--icode-error-color-deprecated-bg);
  border-color: var(--icode-error-color-deprecated-border);
}
.custom-tag-warning {
  color: var(--icode-warning-color);
  background: var(--icode-warning-color-deprecated-bg);
  border-color: var(--icode-warning-color-deprecated-border);
}
...
.custom-timeline-item-head-green {
  color: var(--icode-success-color);
  border-color: var(--icode-success-color);
}
...
.custom-tooltip-pink .custom-tooltip-arrow-content {
  background-color: #eb2f96;
}
.custom-tooltip-magenta .custom-tooltip-inner {
  background-color: #eb2f96;
}
.custom-tooltip-magenta .custom-tooltip-arrow-content {
  background-color: #eb2f96;
}
.custom-tooltip-red .custom-tooltip-inner {
  background-color: #f5222d;
}
.custom-tooltip-red .custom-tooltip-arrow-content {
  background-color: #f5222d;
}
.custom-tooltip-volcano .custom-tooltip-inner {
  background-color: #fa541c;
}
.custom-tooltip-volcano .custom-tooltip-arrow-content {
  background-color: #fa541c;
}
.custom-tooltip-orange .custom-tooltip-inner {
  background-color: #fa8c16;
}
.custom-tooltip-orange .custom-tooltip-arrow-content {
  background-color: #fa8c16;
}
.custom-tooltip-yellow .custom-tooltip-inner {
  background-color: #fadb14;
}
.custom-tooltip-yellow .custom-tooltip-arrow-content {
  background-color: #fadb14;
}
.custom-tooltip-gold .custom-tooltip-inner {
  background-color: #faad14;
}
.custom-tooltip-gold .custom-tooltip-arrow-content {
  background-color: #faad14;
}
.custom-tooltip-cyan .custom-tooltip-inner {
  background-color: #13c2c2;
}
.custom-tooltip-cyan .custom-tooltip-arrow-content {
  background-color: #13c2c2;
}
.custom-tooltip-lime .custom-tooltip-inner {
  background-color: #a0d911;
}
.custom-tooltip-lime .custom-tooltip-arrow-content {
  background-color: #a0d911;
}
.custom-tooltip-green .custom-tooltip-inner {
  background-color: #52c41a;
}
.custom-tooltip-green .custom-tooltip-arrow-content {
  background-color: #52c41a;
}
.custom-tooltip-blue .custom-tooltip-inner {
  background-color: #1890ff;
}
.custom-tooltip-blue .custom-tooltip-arrow-content {
  background-color: #1890ff;
}
.custom-tooltip-geekblue .custom-tooltip-inner {
  background-color: #2f54eb;
}
.custom-tooltip-geekblue .custom-tooltip-arrow-content {
  background-color: #2f54eb;
}
.custom-tooltip-purple .custom-tooltip-inner {
  background-color: #722ed1;
}
.custom-tooltip-purple .custom-tooltip-arrow-content {
  background-color: #722ed1;
}
.custom-tooltip-rtl {
  direction: rtl;
...
.custom-transfer-list-content-item-remove:focus,
.custom-transfer-list-content-item-remove:hover {
  color: var(--icode-primary-color-hover);
}
.custom-transfer-list-content-item-remove:active {
  color: var(--icode-primary-color-active);
}
...
.custom-transfer-list-content-item:not(.custom-transfer-list-content-item-disabled).custom-transfer-list-content-item-checked:hover {
  background-color: var(--icode-primary-color-active-deprecated-d-02);
}
...
.custom-tree-treenode:hover .custom-tree-draggable-icon {
  opacity: 0.45;
}
...
.custom-tree .custom-tree-treenode.drop-container > [draggable] {
  box-shadow: 0 0 0 2px var(--icode-primary-color);
}
...
.custom-select-tree-treenode:hover .custom-select-tree-draggable-icon {
  opacity: 0.45;
}
...
.custom-typography-expand:focus,
.custom-typography-edit:focus,
.custom-typography-copy:focus,
...
.custom-upload-list-item .anticon-close {
  position: absolute;
  top: 6px;
  right: 4px;
  color: rgba(0, 0, 0, 0.45);
...
.custom-upload-list-item .anticon-close:hover {
  color: rgba(0, 0, 0, 0.85);
}
.custom-upload-list-item:hover .custom-upload-list-item-info {
  background-color: #f5f5f5;
}
.custom-upload-list-item:hover .anticon-close {
  opacity: 1;
}
...
.custom-upload-list-picture-card .custom-upload-list-item-error .custom-upload-list-item-thumbnail .anticon svg path[fill='#e6f7ff'] {
  fill: var(--icode-error-color-deprecated-bg);
}
...
.custom-upload-list-picture .anticon-close,
.custom-upload-list-picture-card .anticon-close {
  position: absolute;
  top: 8px;
  right: 8px;
  line-height: 1;
...
.custom-upload-list-picture-card.custom-upload-list::after {
  display: none;
}
.custom-upload-list-picture-card .custom-upload-list-item {
  height: 100%;
...
.custom-upload-list-rtl .custom-upload-list-item .anticon-close {
  right: auto;
  left: 4px;
}
...
.custom-upload-list-rtl.custom-upload-list-picture .anticon-close,
.custom-upload-list-rtl.custom-upload-list-picture-card .anticon-close {
  right: auto;
  left: 8px;
}
