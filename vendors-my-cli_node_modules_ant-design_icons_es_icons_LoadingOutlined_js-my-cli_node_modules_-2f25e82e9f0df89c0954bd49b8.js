"use strict";
(self["webpackChunkicode_run"] = self["webpackChunkicode_run"] || []).push([["vendors-my-cli_node_modules_ant-design_icons_es_icons_LoadingOutlined_js-my-cli_node_modules_-2f25e8"],{
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "Z": () => (/* binding */ CSSMotionList)
});

// UNUSED EXPORTS: genCSSMotionList
...
// EXTERNAL MODULE: ../my-cli/node_modules/rc-motion/es/CSSMotion.js
var es_CSSMotion = __webpack_require__(57299);
// EXTERNAL MODULE: ../my-cli/node_modules/rc-motion/es/util/motion.js
var motion = __webpack_require__(38732);
...
}]);return CSSMotionList;}(index_js_.Component);CSSMotionList.defaultProps={component:'div'};return CSSMotionList;}/* harmony default export */ const CSSMotionList = (genCSSMotionList(motion/* supportTransition */.Cq));
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(43281);
/* harmony import */ var _babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(81220);
/* harmony import */ var _babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(65028);
/* harmony import */ var _babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(53676);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(84251);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
var DomWrapper=/*#__PURE__*/function(_React$Component){(0,_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(DomWrapper,_React$Component);var _super=(0,_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(DomWrapper);function DomWrapper(){(0,_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(this,DomWrapper);return _super.apply(this,arguments);}(0,_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z)(DomWrapper,[{key:"render",value:function render(){return this.props.children;}}]);return DomWrapper;}(react__WEBPACK_IMPORTED_MODULE_0__.Component);/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DomWrapper);
...
var useIsomorphicLayoutEffect=(0,rc_util_es_Dom_canUseDom__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)()?react__WEBPACK_IMPORTED_MODULE_0__.useLayoutEffect:react__WEBPACK_IMPORTED_MODULE_0__.useEffect;/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (useIsomorphicLayoutEffect);
...
// EXTERNAL MODULE: ../my-cli/node_modules/rc-motion/es/interface.js
var es_interface = __webpack_require__(47268);
// EXTERNAL MODULE: ../my-cli/node_modules/rc-motion/es/hooks/useStepQueue.js + 1 modules
var useStepQueue = __webpack_require__(8808);
// EXTERNAL MODULE: ../my-cli/node_modules/rc-motion/es/util/motion.js
var motion = __webpack_require__(38732);
...
function removeMotionEvents(element){if(element){element.removeEventListener(motion/* transitionEndName */.SG,onInternalMotionEnd);element.removeEventListener(motion/* animationEndName */.nI,onInternalMotionEnd);}}// Patch events
function patchMotionEvents(element){if(cacheElementRef.current&&cacheElementRef.current!==element){removeMotionEvents(cacheElementRef.current);}if(element&&element!==cacheElementRef.current){element.addEventListener(motion/* transitionEndName */.SG,onInternalMotionEnd);element.addEventListener(motion/* animationEndName */.nI,onInternalMotionEnd);// Save as cache in case dom removed trigger by `motionDeadline`
...
// EXTERNAL MODULE: ../my-cli/node_modules/rc-motion/es/hooks/useIsomorphicLayoutEffect.js
var useIsomorphicLayoutEffect = __webpack_require__(2689);
...
return;}var currentActive=activeRef.current;var canEnd;if(status===es_interface/* STATUS_APPEAR */.LO&&currentActive){canEnd=onAppearEnd===null||onAppearEnd===void 0?void 0:onAppearEnd(element,event);}else if(status===es_interface/* STATUS_ENTER */.Df&&currentActive){canEnd=onEnterEnd===null||onEnterEnd===void 0?void 0:onEnterEnd(element,event);}else if(status===es_interface/* STATUS_LEAVE */.jf&&currentActive){canEnd=onLeaveEnd===null||onLeaveEnd===void 0?void 0:onLeaveEnd(element,event);}// Only update status when `canEnd` and not destroyed
if(status!==es_interface/* STATUS_NONE */.ib&&currentActive&&canEnd!==false){setStatus(es_interface/* STATUS_NONE */.ib,true);setStyle(null,true);}}var _useDomMotionEvents=useDomMotionEvents(onInternalMotionEnd),_useDomMotionEvents2=(0,slicedToArray/* default */.Z)(_useDomMotionEvents,1),patchMotionEvents=_useDomMotionEvents2[0];// ============================= Step =============================
var eventHandlers=index_js_.useMemo(function(){var _ref2,_ref3,_ref4;switch(status){case es_interface/* STATUS_APPEAR */.LO:return _ref2={},(0,defineProperty/* default */.Z)(_ref2,es_interface/* STEP_PREPARE */.yH,onAppearPrepare),(0,defineProperty/* default */.Z)(_ref2,es_interface/* STEP_START */.$D,onAppearStart),(0,defineProperty/* default */.Z)(_ref2,es_interface/* STEP_ACTIVE */.fh,onAppearActive),_ref2;case es_interface/* STATUS_ENTER */.Df:return _ref3={},(0,defineProperty/* default */.Z)(_ref3,es_interface/* STEP_PREPARE */.yH,onEnterPrepare),(0,defineProperty/* default */.Z)(_ref3,es_interface/* STEP_START */.$D,onEnterStart),(0,defineProperty/* default */.Z)(_ref3,es_interface/* STEP_ACTIVE */.fh,onEnterActive),_ref3;case es_interface/* STATUS_LEAVE */.jf:return _ref4={},(0,defineProperty/* default */.Z)(_ref4,es_interface/* STEP_PREPARE */.yH,onLeavePrepare),(0,defineProperty/* default */.Z)(_ref4,es_interface/* STEP_START */.$D,onLeaveStart),(0,defineProperty/* default */.Z)(_ref4,es_interface/* STEP_ACTIVE */.fh,onLeaveActive),_ref4;default:return{};}},[status]);var _useStepQueue=(0,useStepQueue/* default */.ZP)(status,function(newStep){// Only prepare step can be skip
if(newStep===es_interface/* STEP_PREPARE */.yH){var onPrepare=eventHandlers[es_interface/* STEP_PREPARE */.yH];if(!onPrepare){return useStepQueue/* SkipStep */.I5;}return onPrepare(getDomElement());}// Rest step is sync update
// Rest step is sync update
if(step in eventHandlers){var _eventHandlers$step;setStyle(((_eventHandlers$step=eventHandlers[step])===null||_eventHandlers$step===void 0?void 0:_eventHandlers$step.call(eventHandlers,getDomElement(),null))||null);}if(step===es_interface/* STEP_ACTIVE */.fh){// Patch events when motion needed
patchMotionEvents(getDomElement());if(motionDeadline>0){clearTimeout(deadlineRef.current);deadlineRef.current=setTimeout(function(){onInternalMotionEnd({deadline:true});},motionDeadline);}}return useStepQueue/* DoStep */.eF;}),_useStepQueue2=(0,slicedToArray/* default */.Z)(_useStepQueue,2),startStep=_useStepQueue2[0],step=_useStepQueue2[1];var active=(0,useStepQueue/* isActive */.zh)(step);activeRef.current=active;// ============================ Status ============================
// Update with new status
(0,useIsomorphicLayoutEffect/* default */.Z)(function(){setAsyncVisible(visible);var isMounted=mountedRef.current;mountedRef.current=true;if(!supportMotion){return;}var nextStatus;// Appear
if(!isMounted&&visible&&motionAppear){nextStatus=es_interface/* STATUS_APPEAR */.LO;}// Enter
if(isMounted&&visible&&motionEnter){nextStatus=es_interface/* STATUS_ENTER */.Df;}// Leave
if(isMounted&&!visible&&motionLeave||!isMounted&&motionLeaveImmediately&&!visible&&motionLeave){nextStatus=es_interface/* STATUS_LEAVE */.jf;}// Update to next status
...
status===es_interface/* STATUS_LEAVE */.jf&&!motionLeave){setStatus(es_interface/* STATUS_NONE */.ib);}},[motionAppear,motionEnter,motionLeave]);(0,index_js_.useEffect)(function(){return function(){mountedRef.current=false;clearTimeout(deadlineRef.current);};},[]);// Trigger `onVisibleChanged`
...
if(asyncVisible){firstMountChangeRef.current=true;}if(asyncVisible!==undefined&&status===es_interface/* STATUS_NONE */.ib){// Skip first render is invisible since it's nothing changed
...
var mergedStyle=style;if(eventHandlers[es_interface/* STEP_PREPARE */.yH]&&step===es_interface/* STEP_START */.$D){mergedStyle=(0,objectSpread2/* default */.Z)({transition:'none'},mergedStyle);}return[status,step,mergedStyle,asyncVisible!==null&&asyncVisible!==void 0?asyncVisible:visible];}
...
var STEP_QUEUE=[es_interface/* STEP_PREPARE */.yH,es_interface/* STEP_START */.$D,es_interface/* STEP_ACTIVE */.fh,es_interface/* STEP_ACTIVATED */.cD];/** Skip current step */var SkipStep=false;/** Current step should be update in */var DoStep=true;function isActive(step){return step===es_interface/* STEP_ACTIVE */.fh||step===es_interface/* STEP_ACTIVATED */.cD;}/* harmony default export */ const useStepQueue = (function(status,callback){var _useState=(0,useState/* default */.Z)(es_interface/* STEP_NONE */.EQ),_useState2=(0,slicedToArray/* default */.Z)(_useState,2),step=_useState2[0],setStep=_useState2[1];var _useNextFrame=useNextFrame(),_useNextFrame2=(0,slicedToArray/* default */.Z)(_useNextFrame,2),nextFrame=_useNextFrame2[0],cancelNextFrame=_useNextFrame2[1];function startQueue(){setStep(es_interface/* STEP_PREPARE */.yH,true);}(0,useIsomorphicLayoutEffect/* default */.Z)(function(){if(step!==es_interface/* STEP_NONE */.EQ&&step!==es_interface/* STEP_ACTIVATED */.cD){var index=STEP_QUEUE.indexOf(step);var nextStep=STEP_QUEUE[index+1];var result=callback(step);if(result===SkipStep){// Skip when no needed
