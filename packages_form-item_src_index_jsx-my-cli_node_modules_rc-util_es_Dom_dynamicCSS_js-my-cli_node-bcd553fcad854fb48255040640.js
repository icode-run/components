"use strict";
(self["webpackChunkicode_run"] = self["webpackChunkicode_run"] || []).push([["packages_form-item_src_index_jsx-my-cli_node_modules_rc-util_es_Dom_dynamicCSS_js-my-cli_node-bcd553"],{
...
;// CONCATENATED MODULE: ./packages/form-item/src/index.module.less
// extracted by mini-css-extract-plugin
/* harmony default export */ const index_module = ({"box":"packages-form-item-src-index-module__box","right":"packages-form-item-src-index-module__right","center":"packages-form-item-src-index-module__center"});
;// CONCATENATED MODULE: ./packages/form-item/src/index.jsx
 ...
 */var MyFormItem=/*#__PURE__*/function(_Component){_inherits(MyFormItem,_Component);var _super=_createSuper(MyFormItem);function MyFormItem(){_classCallCheck(this,MyFormItem);return _super.apply(this,arguments);}_createClass(MyFormItem,[{key:"render",value:function render(){var _this$props=this.props,buttonAlign=_this$props.buttonAlign,children=_this$props.children,className=_this$props.className,style=_this$props.style;var buttonStyle={};if(buttonAlign==='inputLeft'){buttonStyle.width='100%';buttonStyle.textAlign='left';}else if(buttonAlign){buttonStyle.width='100%';buttonStyle.textAlign=buttonAlign;}return/*#__PURE__*/index_js_default().createElement(es_form/* default.Item */.Z.Item,{label:buttonAlign==='inputLeft'?' ':null,colon:false,style:_extends({},buttonStyle,style),className:"".concat(index_module.box," ").concat(index_module[buttonAlign]||''," ").concat(className)},children);}}]);return MyFormItem;}(index_js_.Component);;
